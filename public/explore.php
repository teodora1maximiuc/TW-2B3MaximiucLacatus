    ...
    <div class="modal-content">
        ...
        <div class="modal-details">
            <div class="modal-info">
                ...
                <a href="#" class="watch-movie-button" id="watchMovieLink" target="_blank">Watch on Streaming Service</a>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function showModal(title, poster, year, description, movieId) {
            ...
            const streamingServiceLink = getStreamingServiceLink(title);
            $('#watchMovieLink').attr('href', streamingServiceLink);
            modal.css('display', 'block');
        }

        function getStreamingServiceLink(title) {
            const netflixLink = 'https://www.netflix.com/search?q=' + encodeURIComponent(title);
            const disneyLink = 'https://www.disneyplus.com/search?q=' + encodeURIComponent(title);
            return Math.random() < 0.5 ? netflixLink : disneyLink;
        }
        function closeModal() {
